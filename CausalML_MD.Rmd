...
plot(char.res$hpa, ps.fcn(0,0,char.res$hpa,1),main='Plot of Selection rule For Treatment Units',xlab='$ Amt of Highest Previous Contribution',ylab='Pr(Selected in Sample)') 

# Selection rule
# hpa is highest previous contribution. cases is court cases from state which organization was involved.
char.res$ps.select <- ps.fcn(char.res$perbush,char.res$cases,char.res$hpa,char.res$treatment) 
